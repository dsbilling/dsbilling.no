            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{ route('socials.update', $social->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="icon" class="block font-medium text-sm text-gray-700">Icon</label>
                            <input type="text" name="icon" id="icon" class="form-input rounded-md shadow-sm mt-1 block w-full"
