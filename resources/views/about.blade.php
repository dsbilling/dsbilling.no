        ...
        <div class="space-x-0 sm:space-x-5 lg:flex item-center lg:-mx-4">
            <div>
                ...
                <div class="mt-4 text-gray-800 dark:text-gray-100">
                    ...
                    <a class="inline-flex items-center gap-2 justify-center rounded-md py-2 px-3 text-sm outline-offset-2 transition active:transition-none bg-gradient-to-r from-orange-400 to-orange-600 font-bold text-white group mt-6 hover:bg-gradient-to-br hover:shadow-md w-1/2 sm:w-1/3 md:w-1/4"
            ...
            <div class="items-center flex-shrink-0 mx-auto mt-12 lg:px-4 lg:mt-0 sm:mx-0">
                <img alt="Daniel S. Billing" src="{{ asset('img/dsbilling_1024.jpg') }}"
