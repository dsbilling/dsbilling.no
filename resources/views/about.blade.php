        ...
        <div class="space-x-0 sm:space-x-5 lg:flex item-center lg:-mx-4">
            <div>
                ...
                <div class="mt-4 text-gray-800 dark:text-gray-100">
                    ...
                    <p class="mt-10">If you are interested in me and my experience, you can check out my <x-link-text link="https://linkedin.com/in/dsbilling" noreferrer="true">LinkedIn</x-link-text>.</p>
                </div>
            </div>
