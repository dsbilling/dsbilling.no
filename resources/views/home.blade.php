            ...
            <section id="blog" class=" lg:-mx-4">
                ...
                <div class="grid gap-4 pt-8 sm:gap-6 md:grid-cols-2 lg:gap-8">
                    @foreach ($posts as $post)
                        <div class="w-full h-full m-auto overflow-hidden border border-gray-200 rounded-lg shadow-lg cursor-pointer bg-gray-50 hover:bg-gray-100 dark:border-gray-700 group dark:bg-gray-800 hover:dark:bg-gray-700 dark:shadow-gray-100/10">
