            ...
            <div class="space-x-0 sm:space-x-5 lg:flex item-center lg:-mx-4">
                <div>
                    ...
                    <div class="mt-4 text-gray-800 dark:text-gray-100">
                        <p>I currently work as a <x-gradient-text>Backend Developer</x-gradient-text> for <x-link-text link="https://izy.as">Izy AS</x-link-text>, where we develop SaaS for facility services.</p>
                        <p class="mt-2">I previously worked for 10 years at <x-link-text link="https://intility.no">Intility AS</x-link-text> as a <x-gradient-text>Systems Developer</x-gradient-text> in the <x-gradient-text>AV</x-gradient-text> department &mdash; focusing on developing an internal portal, but I also do develop solutions for digital signage as well as programming meeting rooms, auditoriums, and operation centers with <x-link-text link="https://crestron.com">Crestron</x-link-text>.</p>
