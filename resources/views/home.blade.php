    ...
    <div class="mx-auto max-w-2xl lg:max-w-5xl grid sm:grid-cols-2 lg:grid-cols-4">
        <div class="lg:col-span-3">
            ...
            <p class="mt-6 text-base text-slate-600 dark:text-slate-300">
                I am a CTO and Lead Fullstack Developer from Norway. I have a passion for creating and developing digital solutions. Get to know <x-link-text link="{{ route('about') }}" target="_self">about me</x-link-text> or get in touch using any of my socials!
            </p>
