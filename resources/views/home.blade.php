            ...
            <div class="space-x-0 sm:space-x-5 lg:flex item-center lg:-mx-4">
                <div>
                    ...
                    <div class="mt-4 text-gray-800 dark:text-gray-100">
                        ...
                        <p class="mt-2">In January of 2022 I started my own company called <x-link-text link="https://kilobyte.no">Kilobyte AS</x-link-text>. Before this I had a sole proprietorship for 10 years.</p>
